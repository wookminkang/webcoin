...
function Coin(){
    ...
    const routeChkPrice = useRouteMatch(`/${coinId}/price`);
    const routeChkChart = useRouteMatch(`/${coinId}/chart`);
    ...
    return (
            ...
            <Helmet>
              <title>
                ...
                <BackBtn><Link to={"/"}><span className="list" > 목록 </span></Link></BackBtn>
                ...
                <Tabs>
                  <Tab isActive={routeChkPrice !== null}>
                    <Link to={`/${coinId}/chart`}>Chart</Link>
                  </Tab>
                  <Tab isActive={routeChkChart !== null}>
